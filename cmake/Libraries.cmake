...
macro(configure_unix_libs)
  ...
  # On modern macOS, pthread is part of the C library and doesn't need explicit linking
  if(NOT APPLE)
    ...
    # On Apple platforms, pthread is always available and built-in
    set(HAVE_PTHREAD 1)
  endif()
...
macro(configure_windows_openssl)
  ...
  if(EXISTS ${OPENSSL_EXE_DIR})
    ...
    message(FATAL_FATAL "OpenSSL exe dir not found: ${OPENSSL_EXE_DIR}")
  endif()
